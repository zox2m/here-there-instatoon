const qnaList = [
  {
    ...
    a: [
      { answer: 'a. 당장 뭐든 만들어 먹어보자!', type: [1, 2, 4, 9] },
      { answer: 'b. 일단 쉬운 게 있나 찾아보고 생각해보자', type: [0, 3, 6, 5, 10, 8] },
      { answer: 'c. 에이 그냥 시켜먹자', type: [7, 11 ] },
    ]
  },
  {
    q: '2. 취미를 가져볼까 하는데 어떤 취미를 도전해볼까?',
    a: [
      { answer: 'a. 여기저기 돌아다니며 경험하는 활동', type: [0, 3, 2, 8] },
      { answer: 'b. 이것저것 직접 만들어보는 활동', type: [1, 6, 5, 10] },
      { answer: 'c. 꾸준히 노력해서 실력을 쌓아가는 활동', type: [7, 4, 9, 11] },
    ]
  },
  {
    q: '3. 내 앞에 신이 나타나서 능력치를 하나 준다는데 어떤 걸 고를까?',
    a: [
      { answer: 'a. 지능 상승', type: [1, 3, 2, 10, 8] },
      { answer: 'b. 행운 상승', type: [7, 9, 11] },
      { answer: 'c. 손재주 상승', type: [0, 6, 5, 4] }
    ]
  },
  {
    q: '4. 지인이 나에게 종이 한 장을 준다. 받을까 말까?',
    a: [
      { answer: 'a. 일단 받는다 ', type: [1, 2, 4 ] },
      { answer: 'b. 별 필요없으니 안받는다 ', type: [7, 10, 8, 9, 11 ] },
      { answer: 'c. 다시는 이런 거 주지 말라고 소리친다 ', type: [0, 3, 6, 5 ] },
    ]
  },
  {
    q: '5.놀이공원을 갔다. 나는 무엇을 할까?',
    a: [
      { answer: 'a. 여기서 가장 무서운 놀이기구를 도전하러 간다', type: [1, 7, 10, 4, 9 ] },
      { answer: 'b. 놀이공원에 있는 맛있는 음식을 다 부순다', type: [0, 3, 6, 11]},
      { answer: 'c. 주변을 구경하며 사진 찍는다', type: [2, 5, 8] },
    ]
  },
